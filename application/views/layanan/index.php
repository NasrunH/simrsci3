                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                        ...
                        <td class="py-3 px-4 text-center">
                            <div class="flex justify-center gap-2">
                                <?php if($can_edit): ?>
                                <a href="<?= base_url('layanan/edit/'.$l->id_layanan) ?>" class="bg-amber-100 text-amber-700 hover:bg-amber-200 px-3 py-1.5 rounded-md text-xs font-semibold">Edit</a>
                                <?php endif; ?>
                                <?php if($can_delete): ?>
                                <a href="<?= base_url('layanan/delete/'.$l->id_layanan) ?>" class="btn-delete bg-red-100 text-red-700 hover:bg-red-200 px-3 py-1.5 rounded-md text-xs font-semibold">Hapus</a>
                                <?php endif; ?>
                            </div>
                        </td>
                        <?php endif; ?>
