<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
    ...
    <a href="<?= base_url('dokter/create') ?>" class="bg-primary hover:bg-primary-hover text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-colors shadow-sm flex items-center gap-2">
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="text-sm text-gray-700">
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="5" class="text-center py-8 text-gray-500">Belum ada data dokter terdaftar.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
