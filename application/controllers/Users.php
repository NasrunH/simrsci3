...
class Users extends MY_Controller {
    ...
    public function __construct() {
        parent::__construct();
        // Syarat dasar: harus punya permission view_users
    ...
    public function index() {
        ...
        $this->load->view('layouts/template', ['view_name' => 'users/index', 'view_data' => $data]);
    }

    public function create() {
        // Harus punya permission create_users
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $data_profile = [];
                if ($role_name == 'admin') {
                    $data_profile = ['nama_admin' => $this->input->post('nama_admin', TRUE)];
                } elseif ($role_name == 'dokter') {
                    $data_profile = [
    ...
    public function edit($id) {
        // Harus punya permission edit_users
    ...
    public function delete($id) {
        // Harus punya permission delete_users
        ...
        if ($this->User_model->delete($id)) {
            ...
            $this->session->set_flashdata('error', 'Gagal menghapus user. User mungkin terhubung dengan data profil lain.');
        }
        redirect('users');
    }
}